...
* feat!: Add region support (#96) @fatbasstard
* fix!: Force Cloudwatch Loggroup to be created before the Lambda and make it mandatory (#95) @fatbasstard

#### 📖 Documentation

* docs: Update upgrading documentation (#97) @fatbasstard

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-lambda/compare/v2.3.1...v3.0.0

## v2.3.1 - 2025-07-22

### What's Changed

* fix: only retrieve vpc_id from subnet config when subnet_ids are set by @hduijn in https://github.com/schubergphilis/terraform-aws-mcaf-lambda/pull/93

### New Contributors

* @hduijn made their first contribution in https://github.com/schubergphilis/terraform-aws-mcaf-lambda/pull/93

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-lambda/compare/v2.3.0...v2.3.1
...
* feature: Adding vpc_id as input variable (#92) @svashisht03

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-lambda/compare/v2.2.0...v2.3.0
